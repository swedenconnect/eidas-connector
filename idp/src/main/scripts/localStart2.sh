...
# Tomcat
TOMCAT_HOME=$BASE_DIR_WIN/target/dependency/apache-tomcat-8.5.50
...
# IdP and SP settings
#
IDP_ENTITY_ID=https://local.connector.se/idp
SP_ENTITY_ID=https://localhost:9210/idp/metadata/sp
...
-Didp.sp.encryption.key=$SP_CREDENTIALS/sp-ec-encryption.key \
-Didp.sp.encryption.cert=$SP_CREDENTIALS/sp-ec-encryption.crt \
