  ...
  <tr style="padding: 0px; margin: 0px">
    <td>
      <a href="<spring:message code="connector.ui.e-identification-board.info.url" />">
        <img src="<c:url value='/img/logo_full.png' />" height="100" style="margin-bottom: 0px; margin-right: 10px; margin-top: 5px">
      </a>
    </td>
    ...
    <td style="text-align: right"><img src="<c:url value='/img/se-eu4.png' />" height="120" style="margin-bottom: 5px"></td>
  </tr>
</table>
